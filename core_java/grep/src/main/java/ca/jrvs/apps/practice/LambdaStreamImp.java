...
public class LambdaStreamImp  implements LambdaStreamExc{
    ...
    public static void main(String[] args) {
        LambdaStreamImp lse = new LambdaStreamImp();

        // Print Odd
        lse.printOdd(lse.createIntStream(0, 9), lse.getLambdaPrinter("odd number: ", "!"));
    }
    /**
     * Create a String stream from varargs of String
     * <p>
