...
**Centre Director, Mathnasium (May 2024 - Present)**: Managed daily operations, training schedules, and team workflows aligned to learning standards; coordinated KPI tracking and performance summaries (attendance/retention); ensured parent communications and budget/vendor management; prepared monthly reports to HQ; improved center efficiency through data-driven routines.

**GenAI Accelerator Program Participant, Cognizant (January 2025 - April 2025)**: Trained on enterprise GenAI use cases, LLM evaluation, and prompt engineering; built agents for document summarization and trend extraction; integrated Azure OpenAI, LangChain, and Snowflake AI to automate market research and reduce time-to-insight for stakeholders.

**Data Analyst Intern, Fairfield Hotel Group (January 2022 - December 2023)**: Delivered financial and operational analysis across a CRE portfolio; forecasted occupancy/revenue trends; generated KPIs (cap rates, IRR, rent composition); automated monthly pipelines (90% time reduction); built investor dashboards; supported audits and reconciliations with clean documentation.


## Education
**York University (2020 - 2024)**, Bachelor of Science, Computer Science
- Scholarship
